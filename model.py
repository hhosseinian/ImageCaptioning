...
class DecoderRNN(nn.Module):
    ...
    def forward(self, features, captions):
        ...
        # the first value returned by LSTM, i.e., out, is all of the hidden states throughout
        # the sequence. the second is just the most recent hidden state, i.e., hidden
    ...
    def init_weights(self):
        ...
        # init forget gate bias of LSTM to 1 as recommended in # http://proceedings.mlr.press/v37/jozefowicz15.pdf
